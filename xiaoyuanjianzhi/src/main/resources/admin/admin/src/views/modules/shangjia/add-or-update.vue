    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商家地址" prop="shangjiaAddress">
                       <el-input v-model="ruleForm.shangjiaAddress"
                                 placeholder="商家地址" clearable  :readonly="ro.shangjiaAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="商家地址" prop="shangjiaAddress">
                           <el-input v-model="ruleForm.shangjiaAddress"
