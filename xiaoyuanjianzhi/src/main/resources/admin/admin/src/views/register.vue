    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">大学生校园兼职注册</h1>
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="商家地址" class="input" v-if="tableName=='shangjia'">
                                <el-input v-model="ruleForm.shangjiaAddress" autocomplete="off" placeholder="商家地址"  />
                           </el-form-item>
                        -->
                        <!--
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/xiaoyuanjianzhi/img/back-img-bg.jpg);
